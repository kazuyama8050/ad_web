...
namespace Tests\Feature\Deliveler\Template;
...
use Tests\Helper\DelivelerLoginTrait;
...
class CreateTemplateTest extends TestCase
{
    ...
    public function runApi($requestBody, $expectedResponse, $statusCode = 200) {
        DelivelerLoginTrait::delivelerLogin(1, 'validate1@email.com');
        $response = $this->post("/api/deliveler-template-create", $requestBody);
